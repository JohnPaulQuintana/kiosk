    ...
    return (
        ...
        >
            <div className="relative p-4 pl-6">
                ...
                <span className="w-full p-3 lg:w-[80%] bg-white grid grid-cols-1 lg:grid-cols-2 gap-4 relative">
                    <span
                        id="preview-close"
                    ...
                    />
                        ...
                        <div className="w-full h-[20vh] flex items-center justify-center bg-gray-200">
